...
const reply = (teks) => {
            XeonBotInc.sendMessage(m.chat, { text: teks, contextInfo:{"externalAdReply": {"title": ` 𝑯𝒆𝒍𝒍 𝑩𝒐𝒚 𝑴𝑫`,"body": `Subscribe YouTube Channel`, "previewType": "PHOTO","thumbnailUrl": ``,"thumbnail": fs.readFileSync(`./XeonMedia/theme/cheemspic.jpg`),"sourceUrl": `${linkz1}`}}}, { quoted: m})
        }
        
        const replay = (teks) => {
            XeonBotInc.sendMessage(m.chat, { text: teks, contextInfo:{"externalAdReply": {"title": ` 𝑯𝒆𝒍𝒍 𝑩𝒐𝒚 𝑴𝑫`,"body": `Subscribe YouTube Channel`, "previewType": "PHOTO","thumbnailUrl": ``,"thumbnail": fs.readFileSync(`./XeonMedia/theme/cheemspic.jpg`),"sourceUrl": `${linkz2}`}}}, { quoted: m})
        }
        //auto reply by xeon
...
│          (")_(")
└─「 𝑩𝑶𝑻 𝑰𝑵𝑭𝑶 」       
│❏ 𝑺𝒑𝒆𝒆𝒅 : ${latensie.toFixed(4)} miliseconds
│❏ 𝑹𝒖𝒏𝒕𝒊𝒎𝒆 : ${runtime(process.uptime())}
│❏ 𝑩𝒐𝒕 𝑵𝒂𝒎𝒆 : 𝑯𝒆𝒍𝒍 𝑩𝒐𝒚 𝑴𝑫 ≧◡≦
│❏ 𝑶𝒘𝒏𝒆𝒓 𝑵𝒂𝒎𝒆 : ${global.ownername}
│❏ 𝑶𝒘𝒏𝒆𝒓 𝑵𝒐. : ${global.ownernummenu}
│❏ 𝑻𝒊𝒎𝒆  : ${xtime}
│❏ 𝑷𝒍𝒂𝒕𝒇𝒐𝒓𝒎 : ${os.platform()}
│❏ 𝑻𝒐𝒕𝒂𝒍 𝑼𝒔𝒆𝒓 : ${Object.keys(global.db.users).length}
│❏ 𝑻𝒐𝒕𝒂𝒍 𝑯𝒊𝒕 : ${jumlahcmd}
│❏ 𝑻𝒐𝒕𝒂𝒍 𝑯𝒊𝒕 𝑻𝒐𝒅𝒂𝒚 : ${jumlahharian}
│         _/﹋\_
│          (҂`_´)
│        <,︻╦╤─ ҉ - -  
│        _/﹋\_
...
maker.textpro("https://textpro.me/create-glitch-text-effect-style-tik-tok-983.html", [
    `${teks1}`,`${teks2}`])
  .then((data) => XeonBotInc.sendMessage(m.chat, { image: { url: data }, caption: `Made by 𝑯𝒆𝒍𝒍 𝑩𝒐𝒚 𝑴𝑫` }, { quoted: m }))
...
if (isBanChat) return reply(mess.banChat)
             ...
             let anu = await maker.textpro(link, q)
                XeonBotInc.sendMessage(m.chat, { image: { url: anu }, caption: `Made by 𝑯𝒆𝒍𝒍 𝑩𝒐𝒚 𝑴𝑫` }, { quoted: m })
             }
             break
...
let mese = await XeonBotInc.sendMessage(m.chat, {image:{url:emoji.images[4].url}, caption: `Made by 𝑯𝒆𝒍𝒍 𝑩𝒐𝒚 𝑴𝑫`}, {quoted:m})
...
sendOrder(m.chat, teks, "667140254502463", fs.readFileSync('./XeonMedia/theme/cheemsthumb.jpg'), `${global.watermark}`, `𝑯𝒆𝒍𝒍 𝑩𝒐𝒚 𝑴𝑫`, "916909137213@s.whatsapp.net", "AR6NCY8euY5cbS8Ybg5Ca55R8HFSuLO3qZqrIYCT7hQp0g==", "99999999999999999999")
} else if (sizny > 50) {
await XeonBotInc.groupAcceptInvite(vcc).then(async(res) => replay(jsonformat(res))).catch(_ => _)
replay("Succes!")
} else {
...
reply('𝑯𝒆𝒍𝒍 𝑩𝒐𝒚 𝑴𝑫 𝑵𝒐𝒘 𝑷𝒖𝒃𝒍𝒊𝒄')
XeonBotInc.setStatus(`𝑯𝒆𝒍𝒍 𝑩𝒐𝒚 𝑴𝑫 𝑵𝒐𝒘 : 𝑷𝒖𝒃𝒍𝒊𝒄`)
}
break
case 'setstatuts':
case 'setbio':
...
reply('𝑯𝒆𝒍𝒍 𝑩𝒐𝒚 𝑴𝑫 𝑵𝒐𝒘 : 𝑷𝒓𝒊𝒗𝒂𝒕𝒆 ')
XeonBotInc.setStatus(`𝑯𝒆𝒍𝒍 𝑩𝒐𝒚 𝑴𝑫 𝑵𝒐𝒘 : 𝑷𝒓𝒊𝒗𝒂𝒕𝒆`)
}
break
...
let { toAudio } = require('./lib/converter')
let audio = await toAudio(media, 'mp4')
XeonBotInc.sendMessage(m.chat, {document: audio, mimetype: 'audio/mpeg', fileName: `ᴄᴏɴᴠᴇʀᴛᴇᴅ ʙʏ ʜᴇʟʟ ʙ͢ᴏʏ ᴍᴅ🌝`}, { quoted : m })
}
break
                 ...
                 case 'prettycheck':
                    case 'lovelycheck':
                      case 'uglycheck':
                                  	if (isBan) return reply(mess.ban)
	if (isBanChat) return reply(mess.banChat)
				if (!text) return replay(`Tag Someone, Example : ${prefix + command} @HELL-BOY`)
...
XeonBotInc.sendMessage(from, {image : nyz3, caption:`By 𝑯𝒆𝒍𝒍 𝑩𝒐𝒚 𝑴𝑫`}, {quoted:m}) 						
} catch (e) {
error("Error!")
}
break
...
XeonBotInc.send5ButImg(i, txt, `𝑯𝒆𝒍𝒍 𝑩𝒐𝒚 𝑴𝑫`, log0, btn, thum)
}
...
XeonBotInc.send5ButImg(yoi, txt, `𝑯𝒆𝒍𝒍 𝑩𝒐𝒚 𝑴𝑫`, log0, btn, thum)
}
...
await XeonBotInc.send5ButImg(from, `╔═══════✪「 𝑶𝑾𝑵𝑬𝑹 」	
╠ ❐ 𝒔𝒆𝒍𝒇
╠ ❐ 𝒑𝒖𝒃𝒍𝒊𝒄
╠ ❐ 𝒂𝒏𝒕𝒊𝒕𝒂𝒈
╠ ❐ 𝒓𝒆𝒏𝒕𝒃𝒐𝒕 [𝒂𝒅𝒅/𝒅𝒆𝒍]
...
╠═══════✪「 𝑪𝑶𝑵𝑽𝑬𝑹𝑻 」
╠ ❐ 𝒕𝒐𝒊𝒎𝒂𝒈𝒆 [𝒓𝒆𝒑𝒍𝒚 𝒔𝒕𝒊𝒄𝒌]
╠ ❐ 𝒔𝒕𝒊𝒄𝒌𝒆𝒓 [𝒓𝒆𝒑𝒍𝒚 𝒊𝒎𝒈|𝒈𝒊𝒇]
╠ ❐ 𝒕𝒂𝒌𝒆 [𝒓𝒆𝒑𝒍𝒚 𝒊𝒎𝒈|𝒈𝒊𝒇|𝒔𝒕𝒊𝒌]
╠ ❐ 𝒔𝒎𝒆𝒎𝒆 [𝒓𝒆𝒑𝒍𝒚 𝒊𝒎𝒈]
╠ ❐ 𝒆𝒎𝒐𝒋𝒊𝒎𝒊𝒙 [𝒎𝒐𝒋𝒊+𝒎𝒐𝒋𝒊]
╠ ❐ 𝒆𝒎𝒐𝒋𝒊 [𝒆𝒎𝒐𝒋𝒊]
╠ ❐ 𝒕𝒐𝒗𝒊𝒅𝒆𝒐 [𝒓𝒆𝒑𝒍𝒚 𝒊𝒎𝒈]
...
╠ ❐ 𝒄𝒏𝒏-𝒏𝒆𝒘𝒔 
╠ ❐ 𝒇𝒂𝒋𝒂𝒓-𝒏𝒆𝒘𝒔 
╠❐ 𝒇𝒓𝒊𝒆𝒏𝒅𝒔𝒉𝒊𝒑𝒔𝒉𝒐𝒓𝒕𝒔𝒕𝒐𝒓𝒚
╠❐ 𝒍𝒐𝒗𝒆𝒔𝒉𝒐𝒓𝒕𝒔𝒕𝒐𝒓𝒚
╠❐ 𝒔𝒂𝒄𝒓𝒊𝒇𝒊𝒄𝒆𝒔𝒉𝒐𝒓𝒕𝒔𝒕𝒐𝒓𝒚
╠❐ 𝒅𝒊𝒔𝒕𝒖𝒓𝒃𝒊𝒏𝒈𝒔𝒉𝒐𝒓𝒕𝒔𝒕𝒐𝒓𝒚
╠❐ 𝒊𝒔𝒍𝒂𝒎𝒊𝒄𝒔𝒉𝒐𝒓𝒕𝒔𝒕𝒐𝒓𝒚
╠❐ 𝒄𝒊𝒏𝒆𝒎𝒂𝒔𝒄𝒉𝒆𝒅𝒖𝒍𝒆
╠❐ 𝒏𝒐𝒘𝒑𝒍𝒂𝒚𝒊𝒏𝒈𝒄𝒊𝒏𝒆𝒎𝒂
╠❐ 𝒂𝒎𝒊𝒏𝒐
...
await XeonBotInc.send5ButImg(from, `╔═══════✪「 𝑮𝑹𝑶𝑼𝑷 」	
╠❐ 𝒈𝒓𝒐𝒖𝒔𝒆𝒕𝒕𝒊𝒏𝒈
╠❐ 𝒈𝒓𝒐𝒖𝒑𝒍𝒊𝒏𝒌
╠❐ 𝒆𝒑𝒉𝒆𝒎𝒆𝒓𝒂𝒍 [𝒐𝒑𝒕𝒊𝒐𝒏]
╠❐ 𝒔𝒆𝒕𝒈𝒄𝒑𝒑 [𝒊𝒎𝒂𝒈𝒆]
...
await XeonBotInc.send5ButImg(from, `╔═══════✪「 𝑴𝑨𝑲𝑬𝑹 」	
╠❐ 𝒄𝒂𝒏𝒅𝒚
╠❐ 𝒃𝒍𝒂𝒄𝒌𝒑𝒊𝒏𝒌𝒏𝒆𝒐𝒏
╠❐ 𝒅𝒆𝒆𝒑𝒔𝒆𝒂
╠❐ 𝒔𝒄𝒊𝒇𝒊
...
await XeonBotInc.send5ButImg(from, `╔═══════✪「 𝑫𝑶𝑾𝑵𝑳𝑶𝑨𝑫  」	
╠❐ 𝒊𝒏𝒔𝒕𝒂𝒈𝒓𝒂𝒎 [𝒖𝒓𝒍]
╠❐ 𝒊𝒈𝒕𝒗 [𝒖𝒓𝒍]
╠❐ 𝒊𝒈𝒔𝒕𝒐𝒓𝒚 [𝒖𝒔𝒆𝒓𝒏𝒂𝒎𝒆]
╠❐ 𝒇𝒂𝒄𝒆𝒃𝒐𝒐𝒌 [𝒖𝒓𝒍]
...
await XeonBotInc.send5ButImg(from, `╔═══════✪「 𝑺𝑬𝑨𝑹𝑪𝑯  」	
╠❐ 𝒑𝒍𝒂𝒚 [𝒒𝒖𝒆𝒓𝒚]
╠❐ 𝒔𝒐𝒏𝒈 [𝒒𝒖𝒆𝒓𝒚]
╠❐ 𝒚𝒕𝒔 [𝒒𝒖𝒆𝒓𝒚]
╠❐ 𝒍𝒚𝒓𝒊𝒄𝒔 [𝒒𝒖𝒆𝒓𝒚]
...
await XeonBotInc.send5ButImg(from, `╔═══════✪「 𝑪𝑶𝑵𝑽𝑬𝑹𝑻  」	
╠ ❐ 𝒕𝒐𝒊𝒎𝒂𝒈𝒆 [𝒓𝒆𝒑𝒍𝒚 𝒔𝒕𝒊𝒄𝒌]
╠ ❐ 𝒔𝒕𝒊𝒄𝒌𝒆𝒓 [𝒓𝒆𝒑𝒍𝒚 𝒊𝒎𝒈|𝒈𝒊𝒇]
╠ ❐ 𝒕𝒂𝒌𝒆 [𝒓𝒆𝒑𝒍𝒚 𝒊𝒎𝒈|𝒈𝒊𝒇|𝒔𝒕𝒊𝒌]
╠ ❐ 𝒔𝒎𝒆𝒎𝒆 [𝒓𝒆𝒑𝒍𝒚 𝒊𝒎𝒈]
...
await XeonBotInc.send5ButImg(from, `╔═══════✪「 𝑹𝑨𝑵𝑫𝑶𝑴 𝑰𝑴𝑨𝑮𝑬  」	
╠❐ 𝒄𝒐𝒇𝒇𝒆𝒆
╠❐ 𝒃𝒕𝒔
╠❐ 𝒘𝒐𝒐𝒇
╠❐ 𝒎𝒆𝒐𝒘
...
await XeonBotInc.send5ButImg(from, `╔═══════✪「 𝑨𝑵𝑰𝑴𝑬 」	
╠❐ 𝒏𝒆𝒌𝒐𝟐
╠❐ 𝒘𝒂𝒊𝒇𝒖
╠❐ 𝒘𝒂𝒊𝒇𝒖𝟐
╠❐ 𝒂𝒘𝒐𝒐𝟐
...
await XeonBotInc.send5ButImg(from, `╔═══════✪「 𝑺𝑻𝑰𝑪𝑲𝑬𝑹  」	
╠ ❐ 𝒑𝒂𝒕𝒓𝒊𝒄𝒌
╠ ❐ 𝒆𝒎𝒐𝒋𝒊
╠ ❐ 𝒆𝒎𝒐𝒋𝒊𝒎𝒊𝒙
╠ ❐ 𝒂𝒕𝒕𝒑
...
await XeonBotInc.send5ButImg(from, `╔═══════✪「 𝑨𝑵𝑰𝑴𝑬 𝑺𝑻𝑰𝑪𝑲𝑬𝑹  」	
╠❐ 𝒍𝒐𝒍𝒊
╠❐ 𝒃𝒖𝒍𝒍𝒚
╠❐ 𝒄𝒖𝒅𝒅𝒍𝒆
╠❐ 𝒄𝒓𝒚
...
await XeonBotInc.send5ButImg(from, `╔═══════✪「 𝑵𝑺𝑭𝑾 」	
╠❐ 𝒉𝒆𝒏𝒕𝒂𝒊𝒗𝒊𝒅𝒆𝒐
╠❐ 𝒚𝒖𝒓𝒊
╠❐ 𝒎𝒂𝒔𝒕𝒖𝒓𝒃𝒂𝒕𝒊𝒐𝒏
╠❐ 𝒕𝒉𝒊𝒈𝒉𝒔
...
await XeonBotInc.send5ButImg(from, `╔═══════✪「 𝑭𝑼𝑵 」	
╠ ❐ 𝒉𝒐𝒘 [𝒕𝒆𝒙𝒕
╠ ❐ 𝒘𝒉𝒆𝒏 [𝒕𝒆𝒙𝒕]
╠ ❐ 𝒘𝒉𝒆𝒓𝒆 [𝒕𝒆𝒙𝒕]
╠ ❐ 𝒊𝒔 [𝒕𝒆𝒙𝒕]
...
await XeonBotInc.send5ButImg(from, `╔═══════✪「 𝑮𝑨𝑴𝑬  」	
╠ ❐ 𝒕𝒓𝒖𝒕𝒉
╠ ❐ 𝒅𝒂𝒓𝒆
╠ ❐ 𝒕𝒊𝒄𝒕𝒂𝒄𝒕𝒐𝒆
╠ ❐ 𝒅𝒆𝒍𝒕𝒕𝒕
...
await XeonBotInc.send5ButImg(from, `╔═══✪「 𝑨𝑵𝑶𝑵𝒀𝑴𝑶𝑼𝑺 」	
╠❐ 𝒂𝒏𝒐𝒏𝒚𝒎𝒐𝒖𝒔
╠❐ 𝒔𝒕𝒂𝒓𝒕
╠❐ 𝒏𝒆𝒙𝒕
╠❐ 𝒍𝒆𝒂𝒗𝒆
...
await XeonBotInc.send5ButImg(from, `╔═══════✪「 𝑻𝑶𝑶𝑳 」	
╠ ❐ 𝒕𝒓𝒂𝒏𝒔𝒍𝒂𝒕𝒆 [𝒕𝒆𝒙𝒕]
╠ ❐ 𝒇𝒍𝒊𝒑𝒕𝒆𝒙𝒕 [𝒕𝒆𝒙𝒕]
╠ ❐ 𝒕𝒐𝒍𝒆𝒕𝒕𝒆𝒓 [𝒏𝒖𝒎𝒃𝒆𝒓]
╠✍ ⚞𝑹𝒆𝒅𝒊𝒕𝒆𝒅 𝑩𝒚 𝑯𝒆𝒍𝒍 𝑩𝒐𝒚⚟
...
await XeonBotInc.send5ButImg(from, `╔═══✪「 𝑫𝑨𝑻𝑨𝑩𝑨𝑺𝑬 」	
╠ ❐ 𝒔𝒆𝒕𝒄𝒎𝒅
╠ ❐ 𝒍𝒊𝒔𝒕𝒄𝒎𝒅
╠ ❐ 𝒅𝒆𝒍𝒄𝒎𝒅
╠ ❐ 𝒍𝒐𝒄𝒌𝒄𝒎𝒅
